...
class SeedTypesTable extends Seeder
{
    public function run()
    {
        ...
        Project::create([
            'name' => 'Разработка и развитие метода распознавания объектов на растровых изображениях на основе логической модели с пространственными ограничениями',
            'project_type_id' => '1',
            'start_year' => '2016',
            'finish_year' => ''
        ]);
        Project::create([
            'name' => 'Разработка технологий динамического планирования выполнения композиции сервисов в облачной среде',
            'project_type_id' => '1',
            'start_year' => '',
            'finish_year' => ''
        ]);
        Project::create([
            'name' => 'Технология автоматизации параллельного выполнения инструментов геообработки в модели MapReduce',
            'project_type_id' => '1',
            'start_year' => '',
            'finish_year' => ''
        ]);
        Project::create([
            'name' => 'Оптимизационные методы поиска равновесных решений в конфликтных и иерархических системах управления',
            'project_type_id' => '2',
            'start_year' => '',
            'finish_year' => ''
        ]);
        Project::create([
            'name' => 'Разработка методов исследования и построения иерархических систем децентрализованного интеллектуального управления группами автономных поисково-обследовательских роботов в условиях неопределенности',
            'project_type_id' => '2',
            'start_year' => '2016',
            'finish_year' => '2018'
        ]);
        Project::create([
            'name' => 'Применение параллельных и распределенных алгоритмов решения проблемы булевой выполнимости (SAT) к криптоанализу, поиску комбинаторных структур и исследованию дискретных моделей коллективного поведения',
            'project_type_id' => '2',
            'start_year' => '2016',
            'finish_year' => '2018'
        ]);
        Project::create([
            'name' => 'Параллельные вычисления и методы целочисленного программирования для задач кластеризации и интеллектуального анализа больших массивов данных',
            'project_type_id' => '2',
            'start_year' => '2017',
            'finish_year' => '2018'
        ]);
